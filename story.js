...
const STORY = {
  ...
  board: {
    ...
    threads: [
      ...
      { to: "thread4", label: "4. 【마지막 수수께끼】 아타미 사진집 의혹 스레 4번째" },
    ],
  },
  ...
  scenes: [
...

    {
      ...
      wip: true,   // 제작 중: 일반 플레이어에겐 안 열림(#dev로만 테스트). 완성되면 이 줄 삭제
      entries: [
        ...
        { quiz: { question: "Q. 나머지 도난품이 실려 있는 사진집 페이지는? (4곳, 쉼표로 구분해 입력)", fields: [{ type: "text", placeholder: "예: ○,○,○,○", answers: ["31,32,56,62", "31 32 56 62", "31325662"] }] } },
        ...
        { quiz: { question: "Q. 범인은 어디서 돈을 받았는가?", fields: [{ type: "text", placeholder: "장소 입력", answers: ["熱海駅北側のコインロッカー", "아타미역북쪽코인락커", "아타미역 북쪽 코인락커", "아타미역코인락커", "코인락커"] }] } },
...

    {
      id: "thread4",
      type: "thread",
      title: "【마지막 수수께끼】 아타미 사진집 의혹 스레 4번째",
      ...
      entries: [
        ...
        { quiz: { question: "Q. 편집장이 공물용 신만주를 살 수 있었던 이유는?", fields: [{ type: "text", placeholder: "입력", answers: ["神事用の装束", "신사용의상", "신사용 의상", "신사용복장", "신사용 복장", "신사용제복", "装束", "의상", "복장"] }] } },
        ...
        { post: 31, uid: "y4zmtcaus", body: "편집장 우미하라 나츠미" },
  ...
  finale: {
    ...
    emailFrom: "우미하라 나츠미(海原なつみ)로부터의 메시지",
    emailLines: [
      { t: "많은 응모 감사합니다." },
      { t: "사진집을 다시 한번 잘 봐주세요." },
      { t: "" },
    ...
    finalQuizQuestion: "나(우미하라)가 특별한 마음을 품은 상대의 이름은?",
    ...
    leak: {
      ...
      statements: [
        ...
        { fields: [
          { text: "4. 1~3은 모두 흑막 " },
          { type: "select", answer: "우츠미 코우타", options: ["우미하라 나츠미", "카미시마 모리오", "우츠미 코우타", "오오야마 신이치", "마나카 요스케"] },
          { text: " 의 지시이다." },
        ] },
      ],
      submit: "전송",
  ...
  pages: {
    ...
    hp_shizen: {
      ...
      blocks: [
        ...
        },
        {
          ...
          members: {
            honorary: ["우미하라 나츠미(うなばら なつみ / 출판 편집)"],
            general: [
              "스즈키 코헤이(すずき こうへい / 정치가)",
              "오하시 타케노리(おおはし たけのり / 만두집)",
              "키시 료타(きし りょうた / 제조업)",
              "하나다 카오루(はなだ かおる / 만두집)",
              "시미즈 노리오(しみず のりお / 농가)",
    ...
    hp_shinmanju: {
      ...
      blocks: [
        { lines: [
          "옛날부터 복장(装束)과 함께 그 내용이 전해지고 있습니다. 이 신에게 기도한 덕분에 아타미에서는 천재지변을 피할 수 있다고 합니다.",
        ] },
        { heading: "원재료" },
        { lines: [
          "밀가루, 밀, 설탕, 꿀, 물엿, 전분, 카라멜, 팽창제, 식용 식물성 유지, 유화제(대두 포함)",
          "",
          "6개입  1,200엔(세금 포함)",
        ] },
        { heading: "신사 의식용 만주" },
        { lines: [
          "아타미에서만 자생하는 꽃 「미츠로」를 넣은 공물용(供物用) 만주도 판매하고 있습니다.",
          "※ 공물용은 신사 관계자만 구입하실 수 있습니다.",
        ] },
      ],
    },
  },
