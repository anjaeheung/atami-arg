...
const STORY = {
  ...
  scenes: [
...

    {
      ...
      entries: [
        ...
        { quiz: { question: "Q. 도난품이 놓여 있던 가게의 공통점은?", fields: [{ type: "text", placeholder: "입력", answers: ["鹿頭", "가토", "사슴머리", "사슴 머리", "自然を守る会", "자연을 지키는 회", "자연을지키는회", "자연을지키는회협력점"] }] } },
        ...
        { post: 68, uid: "28r5eduf4", body: "58페이지에 찍혀 있어!" },
        ...
        { post: 71, uid: "g25aueszd", body: "상대의 이 신발, 시즈오카 참의원 의원에게 기념품으로 증정된 신발 아니야?" },
        { post: 72, uid: "swb86w59c", body: "시즈오카 참의원 홈페이지 찾았다!\n미술품 훔치게 한 검은 구두는 이 4명 중 누군가임이 틀림없다!", link: { to: "hp_giin", label: "▶ 시즈오카 참의원 의원 소개" } },
        { quiz: {
            question: "Q. 미술품 도난을 뒤에서 지시한 인물은? 그리고 그 근거는?",
            fields: [
              { type: "text", label: "인물", answers: ["大山新一", "오야마 신이치", "오야마신이치"] },
              { text: "왜냐하면 " },
              { type: "select", answer: "전자동", options: ["차", "자가용", "버기(사륜 오토바이)", "전기", "마이(개인용)", "전자동"] },
              { text: " " },
              { type: "select", answer: "의자", options: ["비행기", "가방", "의자", "오토바이", "세탁기", "TV"] },
              { text: "에 " },
              { type: "select", answer: "올라타서(걸터앉아서)", options: ["치여서", "넋을 잃고 바라보다가", "타고", "올라타서(걸터앉아서)", "찍혀서"] },
              { text: " " },
              { type: "select", answer: "발", options: ["마음", "의혹", "배지", "손", "발", "눈"] },
              { text: "을 " },
              { type: "select", answer: "떼고 있다", options: ["떼고 있다", "잡고 있다·들고 있다", "놓고 있다", "죽이고 있다", "죽어 있다", "떠 있다"] },
            ],
        } },
        { post: 73, uid: "gg65736d9", body: "이 신발 주인, 「전동 의자(휠체어)에 앉아 발을 땅에서 떼고 있는」 사람이야\n오야마 신이치잖아!" },
        { post: 74, uid: "cftizu36i", body: "진짜네\n다른 셋은 다리 멀쩡한데 이 사람만 휠체어네" },
  ...
  pages: {
    ...
    news_misarrest: {
      ...
      images: [
        { src: "images/suspect-face.jpg", caption: "▲ 새롭게 용의자로 발표된 인물" },
      ],
    },
    ...
    hp_giin: {
      ...
      blocks: [
        { heading: "의원 소개" },
        { profile: { image: "images/giin-1.jpg", role: "참의원 의원", name: "의원 ①", sub: "‘시즈오카의 곡예사’" } },
        { lines: ["시즈오카 차 보급 연맹 회장, 시즈오카현 아웃도어 연맹 회장, 시즈오카현 연식야구 연맹 1급 심판원이라는 얼굴을 가지고 있으며, 다양한 직함과 경력을 지닌 것으로부터 ‘시즈오카의 곡예사’라 불리고 있다."] },
        { profile: { image: "images/giin-2.jpg", role: "참의원 의원", name: "의원 ②", sub: "‘이사밍’" } },
        { lines: ["시즈오카 겟코이 TV 보도부 기자 경력을 가지고 있으며, 3기 연속 당선. 시즈오카현민에게 강한 지지를 받고 있어 ‘이사밍’이라는 애칭으로 불리고 있다."] },
        { profile: { image: "images/giin-3.jpg", role: "참의원 의원", name: "오야마 신이치(大山新一)", sub: "‘누구도 버려지지 않는 사회’" } },
        { lines: ["28세 때 사고로 양다리를 움직일 수 없게 되어 휠체어 생활을 하게 됨. 이후 ‘누구도 버려지지 않는 사회’를 만들겠다는 호소를 내걸고 출마하여 의원에 당선되었다."] },
        { profile: { image: "images/giin-4.jpg", role: "참의원 의원", name: "의원 ④", sub: "재정학" } },
        { lines: ["하야카와 대학 정경학부를 거쳐 재팬 은행에 입행. 하야카와 대학 종합연구기구 객원교수를 맡고 있으며, 일본 재정학회에 소속되어 일본 경제의 위험성을 계속해서 호소하고 있다."] },
      ],
    },
    ...
    news_final_arrest: {
      ...
      date: "20XX/5/6 공개",
      body: [
        "건설 예정이던 하츠시마 미술관의 창고에서 미술품이 도난당한 사건으로 지명수배 중이던 가와다 킨조(川田金三) 용의자가, 어제 5월 5일 새벽 아타미 호텔 앞에서 신병이 확보되어 긴급 체포되었다.",
        "이 사건에서는 이전에 카페 점주를 오인 체포한 일이 있어 시즈오카현 경찰에 대한 불신이 높아지고 있었지만, 지명수배된 용의자가 불과 하루 만에 체포됨으로써 경찰의 신속한 대응을 평가하는 목소리도 나오고 있다.",
      ],
      images: [
        { src: "images/kawada.jpg", caption: "▲ 아타미 경찰서로 연행되는 가와다 킨조 용의자" },
      ],
    },
  },
};
