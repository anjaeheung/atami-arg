...
const STORY = {
  ...
  finale: {
    ...
    emailLines: [
      { t: "응모 감사합니다." },
      { t: "다시 한 번 사진집을 되돌아봐 주세요." },
      { t: "" },
      { t: "“아타미를 더럽힌 두 마리의 세피아색 호랑이를", red: true },
      { t: "사슴 대신 푸른색 사진으로 동시에 효수하고”", red: true },
      { t: "“강한 빛으로 비춰낸” 사람에게만", red: true },
      { t: "" },
      { t: "제가 특별한 마음을 품고 있는 상대가 누구인지 알 수 있도록 해두었습니다." },
      { t: "모든 것을 이해한 당신과 이야기할 수 있기를 기대하고 있습니다." },
    ],
